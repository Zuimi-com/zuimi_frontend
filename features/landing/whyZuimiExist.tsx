    ...
    >
      ...
      <div className="relative  z-10 flex justify-end min-h-125 lg:mt-30 -mt-5">
        <div className="max-w-[508px] space-y-2 lg:space-y-6  p-10 rounded-2xl lg:mr-30">
          <h1 className="text-[24px] md:text-[32px] lg:text-[52px] font-extrabold leading-tight text-zuimi-blue -tracking-[2.5px]">
          ...
          <div className="space-y-2 text-white font-semibold md:text-black">
            <p className="text-[12px] md:text-[20px]  leading-relaxed">
